...
public class RegularExJava {
    public static void main(String[] args ){
        ...
        PatternSyntaxException Class - Indicates syntax 
        ...
        */
        ...
        Pattern word = Pattern.compile("maxwell", Pattern.CASE_INSENSITIVE);

        Matcher m = word.matcher("maxwell studies from w3school");
